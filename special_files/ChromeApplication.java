...
public class ChromeApplication extends ContentApplication {
    ...
    public void initCommandLine() {
        ...
        if (!CommandLine.getInstance().hasSwitch(
            ...
            if (!CommandLine.getInstance().hasSwitch(ChromeSwitches.ENABLE_FIRST_RUN_EXPERIENCE)) {
                CommandLine.getInstance().appendSwitch(ChromeSwitches.ENABLE_FIRST_RUN_EXPERIENCE);
            }
